import { fetchInstagramStats, fetchInstagramMediaList } from '../utils/platformApi';
...
async function testModernFlow() {
    ...
    try {
        ...
        const mediaList = await fetchInstagramMediaList(ACCOUNT_ID, 2);
        ...
        const stats = await fetchInstagramStats(TEST_SHORTCODE);
