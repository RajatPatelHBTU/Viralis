...
async function seedMockData() {
    try {
        ...
        for (const business of businesses) {
            ...
            const existingContent = await Content.findOne({ businessId, 'meta.mock': true });
            if (existingContent) {
            ...
            const savedVideos = await Content.insertMany(mockVideos);
            ...
            await VideoAnalysis.insertMany(mockAnalyses);
